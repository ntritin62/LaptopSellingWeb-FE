...
const ProductCard = () => {
  return (
    <Link className="col-span-1">
      <section className="relative rounded-xl hover:scale-102 transition-transform duration-200 ease-out w-[238px] p-[10px] h-[325px] bg-white flex flex-col items-center justify-between">
